...
Vague product or the next stage after an MVP: `/discx` (full `/discovery`) — see DISCOVERY.md. Specs: `/specx` (full `/specxis`). Intensity: `/lexis`. Skip Discovery for bugs and one-file fixes.
